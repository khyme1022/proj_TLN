	...
	if (boardTitle == null || boardContent == null || boardCode == null) {
		...
		pw.println("</script>");
			...
			if (provider.equals("X")) {
				result = boardDAO.update(boardTitle, boardContent, boardCode,boardNO,fileName);
				System.out.println("update1");
			} else {
				result = boardDAO.update(boardTitle, boardContent, boardCode, provider, boardNO,fileName);
